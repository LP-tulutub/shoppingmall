...
import com.shoppingmall.wms.ware.feign.ProductFeignService;
...
import com.shoppingmall.wms.ware.dao.WareSkuDao;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    @Override
    public PageUtils whereQueryPage(Map<String, Object> params) {
        /**
         * skuId: 1
         * wareId: 2
         */
    ...
    public List<SkuHasStockVo> getSkuHasStock(List<Long> skuIds) {
        ...
        return skuIds.stream().map(item -> {
            Long count = this.wareSkuDao.getSkuStock(item);
