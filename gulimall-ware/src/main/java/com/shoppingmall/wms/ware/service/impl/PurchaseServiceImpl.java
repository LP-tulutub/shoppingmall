...
import com.shoppingmall.common.constant.WareConstant;
...
import com.shoppingmall.wms.ware.vo.PurchaseItemDoneVo;
...
import com.shoppingmall.wms.ware.dao.PurchaseDao;
...
public class PurchaseServiceImpl extends ServiceImpl<PurchaseDao, PurchaseEntity> implements PurchaseService {
    ...
    @Override
    public void mergePurchase(Map<String, Object> params) {

        Long purchaseId = Long.parseLong((String) params.get("purchaseId"));
        ...
        if (purchaseId == null) {
            ...
            purchaseEntity.setId(MySnowflakeId.snowflakeWare.nextId());
        ...
        List<Long> items = (List<Long>) params.get("items");
        for (int i = 0; i < items.size(); i++) {
            items.set(i, Long.parseLong(String.valueOf(items.get(i))));
        }
